...
def banner():
	print (G +
	r'''
 ad88888ba   88        88    ,ad8888ba,    88888888ba   88  
d8"     "8b  88        88   d8"'    `"8b   88      "8b  88  
Y8,          88        88  d8'        `8b  88      ,8P  88  
`Y8aaaaa,    88aaaaaaaa88  88          88  88aaaaaa8P'  88  
  `"""""8b,  88""""""""88  88          88  88""""""'    88  
        `8b  88        88  Y8,        ,8P  88           88  
Y8a     a8P  88        88   Y8a.    .a8P   88           88  
 "Y88888P"   88        88    `"Y8888Y"'    88           88  
                                                            
                                                            
''' + W)
	print('\n' + G + '[>]' + C + ' Created By : ' + W + 'SHOPIGANt')
